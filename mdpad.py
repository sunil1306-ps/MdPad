...
body{font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;
     line-height:1.6;color:#222;background:#fefefe;margin:40px auto;max-width:800px;padding:0 20px}
h1,h2,h3,h4,h5,h6{color:#005eb8;margin-top:1.2em;margin-bottom:.6em}
code{background:#f1faee;padding:2px 4px;border-radius:4px;font-size:.9em}
pre{background:#002b36;color:#839496;padding:1em;overflow-x:auto;border-radius:6px;font-size:.88em}
table{border-collapse:collapse;width:100%}
th,td{border:1px solid #ddd;padding:6px 10px}
th{background:#f2f2f2}
blockquote{border-left:4px solid #005eb8;margin:1em 0;padding-left:1em;color:#555}
a{color:#005eb8}
</style>
""")
...
class MdPad(tk.Tk):
    ...
    def build_ui(self):
        ...
        paned = tk.PanedWindow(self, orient=tk.HORIZONTAL, sashwidth=4, bg="#999")
        paned.pack(fill=tk.BOTH, expand=True)

        # left: plain-text editor
        self.text = st.ScrolledText(paned, wrap=tk.WORD, font=("Consolas", 13),
                                    undo=True, insertwidth=2)
